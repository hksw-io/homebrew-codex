cask "codex" do
  ...
  if OS.mac?
    if Hardware::CPU.arm?
      sha256 "78782916ee4e687a415460395252379ac5933d7eb599c8c8636d0fa0e6e5c931"
      url "https://github.com/openai/codex/releases/download/rust-v#{version}/codex-aarch64-apple-darwin.tar.gz"
      binary "codex-aarch64-apple-darwin", target: "codex"
    else
      sha256 "697816e756144c5c94ef7aab101f3849c52d530c7d124efbc04ad8af929d8c31"
    ...
    sha256 "3252340f2ad0f28e11800885623239b6639b0d3d56b0d01e0be831d7a857846c"
    url "https://github.com/openai/codex/releases/download/rust-v#{version}/codex-aarch64-unknown-linux-musl.tar.gz"
    binary "codex-aarch64-unknown-linux-musl", target: "codex"
  else
    sha256 "380535ce8decf2bfeffddb0ad34d668d2388dc07c6310833243482d73a8da220"
